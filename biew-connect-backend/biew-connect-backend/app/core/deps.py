...
# Simple "paste your token" auth scheme for Swagger's Authorize button —
# works with our custom JSON /auth/login endpoint (unlike OAuth2PasswordBearer,
# which expects a username/password form submitted straight to tokenUrl).
